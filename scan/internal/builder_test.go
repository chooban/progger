...
func TestExtractDetailsFromTitle(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:           "Hershey - Bones 3",
			input:          "Hershey - The Cold In The Bones - Book One - Part 8",
			expectedPart:   8,
			expectedTitle:  "Book One: The Cold In The Bones",
			expectedSeries: "Hershey",
		},
		{
			name:           "Aquila - Rivers of Hades Book One",
			input:          "Aquila: The Rivers of Hades Book One - Part 1",
			expectedPart:   1,
			expectedTitle:  "Book One: The Rivers of Hades",
			expectedSeries: "Aquila",
		},
		{
			name:           "Aquila - Rivers of Hades Book Two",
			input:          "Aquila: The Rivers Of Hades - Book Two - Part 1",
			expectedPart:   1,
			expectedTitle:  "Book Two: The Rivers of Hades",
			expectedSeries: "Aquila",
		},
		{
			name:           "Aquila - Mord Venetiae",
			input:          "Aquila: Mord Venetiae",
			expectedPart:   1,
			expectedTitle:  "Mord Venetiae",
			expectedSeries: "Aquila",
		},
		{
			name:           "Cover",
