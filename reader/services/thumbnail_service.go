...
func (s *ThumbnailService) GetSeriesThumbnail(ctx context.Context, cover *models.Cover, seriesName string) ([]byte, error) {
...
func (s *ThumbnailService) GetCoverThumbnail(ctx context.Context, cover *models.Cover) ([]byte, error) {
	var cacheKey string
